...
if ENV:
    ...
    EVENT_LOGS = os.environ.get("EVENT_LOGS", True)
    ...
    UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "MikuXUpdatesChannel")
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "MikuXSupportChat")
    ...
    from AltronX.config import Development as Config
