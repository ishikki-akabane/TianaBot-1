...
import AltronX.modules.sql.users_sql as sql
...
from AltronX.modules import ALL_MODULES
from AltronX.modules.helper_funcs.chat_status import is_user_admin
from AltronX.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("AltronX.modules." + module_name)
...
• We also thank all the groups who rely on our Bot for this service, we hope you will always like it: we are constantly working to improve it!""",
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Nᴇᴡꜱ", url=f"t.me/"),
        ...
        query.message.edit_text(
            text="""*Miku Nakano Source Is Private.*
            ...
            reply_markup=InlineKeyboardMarkup(
               [
                 [
                     ...
                     InlineKeyboardButton(text="📄 𝙐𝙥𝙙𝙖𝙩𝙚𝙨", callback_data="MikuXUpdateschannel"),
                 ],
                 [  
                    InlineKeyboardButton(text="🫂 𝙎𝙪𝙥𝙥𝙤𝙧𝙩", callback_data="MikuxSupportchat"),
                    InlineKeyboardButton(text="👨‍✈️ 𝙊𝙬𝙣𝙚𝙧", url=f"t.me/{OWNER_USERNAME}"),
                 ],
                 [
                     InlineKeyboardButton(text="𝙏𝙚𝙧𝙢𝙨 𝘼𝙣𝙙 𝘾𝙤𝙣𝙙𝙞𝙩𝙞𝙤𝙣𝙨❗️", callback_data="tiana_terms"),
                 ],
                 [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "𝙼𝚒𝚔𝚞 𝙽𝚊𝚔𝚊𝚗𝚘 𝚄𝚙𝚍𝚊𝚝𝚎𝚍 𝚂𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢✅")
        except Unauthorized:
            LOGGER.warning(
