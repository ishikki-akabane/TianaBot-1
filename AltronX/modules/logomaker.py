...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./AltronX/resources/font/*")
    ...
    fname = "Tiana.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Made by [Miku](@MikuX_Robot)")         
    await pesan.delete()
