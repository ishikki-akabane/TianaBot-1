...
from AltronX.__main__ import STATS, TOKEN, USER_INFO
from AltronX.modules.sql import SESSION
import AltronX.modules.sql.userinfo_sql as sql
from AltronX.modules.disable import DisableAbleCommandHandler
from AltronX.modules.sql.global_bans_sql import is_user_gbanned
from AltronX.modules.sql.afk_sql import is_afk, set_afk
from AltronX.modules.sql.users_sql import get_user_num_chats
from AltronX.modules.helper_funcs.chat_status import sudo_plus
from AltronX.modules.helper_funcs.extraction import extract_user
from AltronX import telethn
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nтнιѕ ∂ιѕαѕтєя ℓєνєℓ σƒ тнє ρєяѕση ιѕ 'Dᴇᴍᴏɴ'."
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nтнιѕ ∂ιѕαѕтєя ℓєνєℓ σƒ тнє ρєяѕση ιѕ 'Tɪɢᴇʀ'."
        disaster_level_present = True
    elif user.id in WOLVES:
        text += "\n\nтнιѕ ∂ιѕαѕтєя ℓєνєℓ σƒ тнє ρєяѕση ιѕ 'Wᴏʟғ'."
        disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/MikuXUpdatesChannel/21"),
                            InlineKeyboardButton(
